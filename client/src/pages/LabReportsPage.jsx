...
const LabReportsPage = () => {
  ...
  return (
    <AnimatedPage maxWidth="max-w-3xl">
      <PageHero
        variant="diagnostics"
        eyebrow="Sri Kamala Hospital · Lab desk"
        title="ల్యాబ్ రిపోర్ట్ ట్రాకింగ్"
        subtitle="Submit a lab report request or check status by phone or token."
        icon={FlaskConical}
      >
        <Link to="/diagnosis" className="hero-btn-ghost">
          Browse tests
        </Link>
      </PageHero>

      <motion.div className="pro-card p-6 sm:p-8 mb-8" {...sectionReveal}>
      ...
      <motion.div className="pro-card p-6 sm:p-8" {...sectionReveal}>
        <h2 className="text-lg font-bold text-theme flex items-center gap-2 mb-4">
                ...
                <div className="flex justify-between items-start gap-2">
                  <div>
                    ...
                    <p className="text-xs text-theme-muted">
                      {r.patient_name || r.patientName} · {r.token}
                    </p>
                  </div>
      ...
      <motion.p
        className="text-center text-xs text-theme-muted mt-8 flex items-center justify-center gap-2"
        {...sectionReveal}
      >
