...
export const adminT = {
  en: {
    ...
    diag: {
      loginTitle: 'Diagnostics Lab Panel',
      loginSub: 'Lab staff — same password, select Diagnostics role',
      ...
      overview: {
        ...
        quick: 'Manage blood test catalog, track report requests, and update lab bookings.',
      },
      catalog: {
        title: 'Blood test catalog',
        sub: 'Shown on the public Diagnostics page — add image URL per test',
        add: 'Add test',
        save: 'Save',
        deactivate: 'Hide from site',
        empty: 'No tests in database — defaults shown on website until you add tests',
      },
      bookings: {
        title: 'Lab test bookings',
        sub: 'Appointments booked from the Diagnostics page',
        empty: 'No lab bookings yet',
      },
      settings: {
        title: 'Lab contact settings',
        phone: 'Diagnostics lab phone',
        timings: 'Lab hours (display text)',
        save: 'Save settings',
      },
    },
    logout: 'Sign out',
  ...
  te: {
    ...
    diag: {
      loginTitle: 'డయాగ్నాస్టిక్స్ ల్యాబ్ ప్యానెల్',
      loginSub: 'ల్యాబ్ స్టాఫ్ — అదే పాస్‌వర్డ్, Diagnostics ఎంచుకోండి',
      role: 'ల్యాబ్ అడ్మిన్',
      tabs: {
        overview: 'డాష్‌బోర్డ్',
        catalog: 'పరీక్షల కేటలాగ్',
        bookings: 'పరీక్ష బుకింగ్‌లు',
        reports: 'రిపోర్ట్ ట్రాకింగ్',
        settings: 'ల్యాబ్ సెట్టింగ్‌లు',
      },
      overview: {
        title: 'ల్యాబ్ సారాంశం',
        tests: 'సక్రియ పరీక్షలు',
        pending: 'రిపోర్ట్ వేచి',
        bookings: 'ల్యాబ్ బుకింగ్‌లు',
        quick: 'రక్త పరీక్షలు, రిపోర్ట్ అభ్యర్థనలు, బుకింగ్‌లు నిర్వహించండి.',
      },
      catalog: {
        title: 'రక్త పరీక్షల కేటలాగ్',
        sub: 'పబ్లిక్ డయాగ్నాస్టిక్స్ పేజీలో కనిపిస్తుంది',
        add: 'పరీక్ష జోడించు',
        save: 'సేవ్',
        deactivate: 'సైట్ నుండి దాచు',
        empty: 'డేటాబేస్‌లో పరీక్షలు లేవు',
      },
      bookings: {
        title: 'ల్యాబ్ బుకింగ్‌లు',
        sub: 'డయాగ్నాస్టిక్స్ పేజీ నుండి బుక్ చేసినవి',
        empty: 'ఇంకా బుకింగ్‌లు లేవు',
      },
      settings: {
        title: 'ల్యాబ్ సంప్రదింపు',
        phone: 'ల్యాబ్ ఫోన్ నంబర్',
        timings: 'ల్యాబ్ సమయాలు',
        save: 'సెట్టింగ్‌లు సేవ్',
      },
    },
    logout: 'సైన్ అవుట్',
    lang: 'భాష',
